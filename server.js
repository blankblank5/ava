...
server.listen(PORT, () => { console.log(`Server Auth Engine listening on port ${PORT}`); }); Now I will move on to my package.json it is {

  "name": "elemental-game",

  "version": "1.0.0",

  "description": "Multiplayer Elemental Arena",
